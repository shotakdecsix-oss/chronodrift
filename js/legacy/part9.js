...
function animate() {
  ...
  for (let n = 0; n < _buildBudget && pendingBuildingIdx < pendingBuildings.length; n++) {
    ...
    if (b.real || !isOnRoad(b.x, b.z, b.w, b.d)) addBuilding(b.x, b.z, b.w, b.d, b.h, b.style, b.real, b.rot, b.name, b.kind);
    _bgGenerated++;
  }
  ...
  scanSeaBed(); // 【2026-08-13・TERRAIN_YIELDS_TO_SEA_V2.md】海の下の地形を海面下へ落とす低頻度スキャン(part4.js)
  ...
  checkNearbyPlace(); // 近くの駅名・施設名(A-1)。通信は増やさずローカル判定のみ高頻度で更新
